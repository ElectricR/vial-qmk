...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BOTH] = LAYOUT_5x6(
     LT_GAM,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,           KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
  ...
  [_GAMING1] = LAYOUT_5x6(
     KC_GRV,  KC_NO,   KC_1,    KC_2,    KC_3,    KC_4,            KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
  ...
  [_GAMING2] = LAYOUT_5x6(
     ...
     KC_NO,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,         KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
