...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DVORAK] = LAYOUT_5x6(
     ...
     KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_BSLS,
                       KC_NO,   KC_NO,                                               KC_EQL,  KC_RBRC,
                                L_BOTH,  KC_SPC,  KC_LSFT,         KC_RGUI, KC_ENT,  KC_LALT
  ),
  [_BOTH] = LAYOUT_5x6(
     ...
     RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, KC_NO,   KC_NO,           KC_NO,   KC_NO,   KC_WH_U, KC_NO,    KC_NO,   QK_BOOT,
                       RGB_VAD, RGB_VAI,                                             KC_WH_D, KC_NO,
                                KC_NO,   KC_NO,   KC_NO,           KC_CAPS, KC_NO,   KC_NO
  ),
  [_GAMING1] = LAYOUT_5x6(
     KC_NO,   KC_NO,   KC_P1,   KC_P2,   KC_P3,   KC_P4,           KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
     KC_ESC,  KC_T,    KC_Q,    KC_W,    KC_D,    KC_R,            KC_NO,   KC_MPLY, KC_MNXT, KC_MPRV,  KC_MSTP, KC_NO,
     KC_TAB,  KC_F,    KC_A,    KC_S,    KC_E,    KC_G,            KC_NO,   KC_NO,   MYKEY,   KC_NO,    KC_NO,   KC_NO,
  ...
  [_GAMING2] = LAYOUT_5x6(
     KC_NO,   KC_F14,  KC_P5,   KC_P6,   KC_P7,   KC_P8,           KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
